...
namespace BadStateful
{
    ...
    internal sealed class BadStateful : StatefulService
    {
        ...
        {
            long localValue = 0;
            string stateKey = "Counter-Unique";
            ...
            while (true)
            {
                ...
                {
                    var result = await myDictionary.TryGetValueAsync(tx, "stateKey");
                    ...
                    await myDictionary.AddOrUpdateAsync(tx, "stateKey", 0, (key, value) => ++value);
